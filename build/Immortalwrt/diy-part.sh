...
# === 可选开关（编译特性） ===
export Enable_FW4="0"                    # 启用 fw4(nftables) 防火墙：1=启用（需要源码支持/会自动尝试拉取 firewall4 包），0=默认 iptables/firewall3
export Preload_GeoData="0"               # 预置 GeoIP/GeoSite 数据：1=编译时下载写入固件（约30MB），0=不预置
